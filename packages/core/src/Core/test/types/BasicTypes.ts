namespace BasicTypes {
     ...
     * numbers, strings, structures, boolean values, and the like. In TypeScript, we support
     * much the same types as you would expect in JavaScript, with a convenient enumeration
     * type thrown in to help things along.
     */
    ...
    class String {
        ...
        sentence = `Hello, my name is ${this.fullName}.
